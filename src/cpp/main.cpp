...
int main(int argc, char *argv[])
{
	...
	get_input_label("./Resource/data/input_label_1000.xml", input, label, sample_number);
	get_input_label("./Resource/data/input_label_1000.xml", test_input, test_label, 200, 800);
	...
	if (flag == 0)
	{
		...
		//Save model.
		net.save("./Resource/model/model_sigmoid_800_200.xml");
	}
	if (flag == 1)
	{
		net.load("./Resource/model/model_sigmoid_800_200.xml");
